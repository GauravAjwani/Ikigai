...
class Settings(BaseSettings):
    ...
    max_slack_searches: int = 3
    max_rank_candidates: int = 12

    firestore_collection: str = "precedent_decisions"
    meter_collection: str = "precedent_meter"
...
def get_settings() -> Settings:
    ...
    if os.environ.get("PRECEDENT_VERTEX", "").lower() in {"1", "true", "yes"}:
